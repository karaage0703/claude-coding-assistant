...
## 概要
GitHub CLIを使用してプルリクエストを自動分析し、体系的なコードレビューを実行するプロンプト。PRテンプレートの観点に基づいて高品質なレビューコメントを効率的に提供する。また、PR自体の記載（タイトル、説明文、テンプレート準拠）の明瞭さもレビューし、チーム全体のPR品質向上に貢献する。
...
- **PR記載レビュー**: コードだけでなくPRのタイトル・説明文・テンプレート準拠もレビューし、チーム全体のPR品質を向上