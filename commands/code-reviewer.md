...
### 5. Codexによるレビュー妥当性確認（推奨）
codex MCPサーバが利用可能な場合、作成したレビューコメントの妥当性を確認：

**実装方法**: `mcp__codex__codex` ツールを使用して、以下のプロンプトでCodexに確認を依頼します。
...
- **codex MCPサーバが利用可能な場合は、必ず妥当性確認を実施すること（推奨）**
